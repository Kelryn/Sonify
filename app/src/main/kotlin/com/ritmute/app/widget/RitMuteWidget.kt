package com.ritmute.app.widget
...
import com.ritmute.app.MainActivity
 ...
 */
class RitMuteWidget : GlanceAppWidget() {
...
private fun WidgetBody(title: String, subtitle: String) {
    Column(
        ...
        // Taken from the theme rather than hard-coded: the background above is
        // GlanceTheme.colors.surface, and only its matching onSurface pair is guaranteed to
        // stay legible against it in light mode, in dark mode and under dynamic colour.
        Text(
            text = title,
...
class RitMuteWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = RitMuteWidget()
}
