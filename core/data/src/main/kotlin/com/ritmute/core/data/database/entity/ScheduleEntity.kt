 ...
 *
 * The domain type [com.ritmute.core.domain.model.Schedule] identifies its parent by
 ...
 * [com.ritmute.core.domain.model.Schedule.validate]; Room cannot declare a `CHECK`.
 */
@Entity(
    tableName = "schedules",
    foreignKeys = [
