 ...
 *
 * [SonoRitmoCodeFreeze] in the test source set fails the build if any code changes.
 */
object EnumCodecs {
    ...
    /** For [com.sonoritmo.core.domain.model.AudioSnapshot], where the mode is not nullable. */
