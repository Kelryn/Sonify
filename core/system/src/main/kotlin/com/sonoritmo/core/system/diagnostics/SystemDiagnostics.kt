...
class SystemDiagnostics @Inject constructor(
     ...
     * "your phone stopped SonoRitmo on the 3rd; between then and now no rule was applied."
     * See docs/02, risk N3.
     */
