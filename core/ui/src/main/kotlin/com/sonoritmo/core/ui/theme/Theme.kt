package com.sonoritmo.core.ui.theme
...
fun SonoRitmoTheme(
    ...
    CompositionLocalProvider(
        ...
        MaterialTheme(
            ...
            typography = SonoRitmoTypography,
            content = content,
        )
    }
}

/** Shorthand so screens read `SonoRitmoTheme.semantic.active` instead of a local lookup. */
object SonoRitmoTheme {
