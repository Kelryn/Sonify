package com.ritmute.feature.profiles.navigation
...
import com.ritmute.feature.profiles.editor.ProfileEditorScreen
import com.ritmute.feature.profiles.editor.ProfileEditorViewModel
import com.ritmute.feature.profiles.list.ProfilesScreen
...
/**
 * Deep links use the `ritmute://` scheme rather than an `https://` one.
 *
...
fun NavGraphBuilder.profilesGraph(
    ...
    composable(
        ...
        deepLinks = listOf(navDeepLink { uriPattern = "ritmute://profiles" }),
    ) {
        ProfilesScreen(
    ...
    composable(
        ...
        deepLinks = listOf(navDeepLink { uriPattern = "ritmute://profile/{${ProfileEditorViewModel.ARG_PROFILE_UUID}}" }),
    ) {
